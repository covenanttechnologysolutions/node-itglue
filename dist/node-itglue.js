(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["node_itglue"] = factory();
	else
		root["node_itglue"] = factory();
})(window, function() {
...
function ITGlue(_ref) {
  ...
  if (!companyUrl && mode === MODE_USER) {
    throw "companyUrl must be defined in mode ".concat(MODE_USER);
  }

  if (!token && mode === MODE_BEARER) {
    throw "token must be defined in mode ".concat(MODE_BEARER);
  }

  if (!apikey && mode === MODE_APIKEY) {
    throw "apikey must be defined in mode ".concat(MODE_APIKEY);
  }
...
//# sourceMappingURL=node-itglue.js.map